...
SROUTER_DECLARED_NAME(keyModuleClassD, @"D_ViewModuleController");
SROUTER_DECLARED_NAME(keyParamsClassD_Title, @"title");
SROUTER_DECLARED_NAME(keyParamsClassD_Content, @"content");

@interface D_ViewModuleController ()<ModuleProtocol>
...
- (void)viewDidLoad {
    ...
    [buttonDidToA setTitleColor:[UIColor yellowColor] forState:UIControlStateNormal];
